# Phase 7: Snowflake Intelligence
...
A good workflow is to start with the Streamlit dashboard (deployed in Phase 3) to spot interesting patterns, then switch to Snowflake Intelligence to dig deeper.

**Start with the Streamlit app** to visually explore stock price trends. Look for interesting days -- big price swings, volume spikes, or unusual trading activity for TSLA (or whichever stocks you loaded).
...
> Tesla's stock dropped 5% in [month]. Is there anything in the earnings reports that would explain a negative movement?

> What was Tesla's stock performance in Q2 2025? Were there any earnings results that quarter that could explain the movement?
