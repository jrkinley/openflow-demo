...
**Start with the Streamlit app** (`snowflake/streamlit_app.py`) to visually explore stock price trends. Look for interesting days -- big price swings, volume spikes, or unusual trading activity for TSLA (or whichever stocks you loaded).
